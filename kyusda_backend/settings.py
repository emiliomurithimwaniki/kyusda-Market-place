"""
Django settings for kyusda_backend project.
...
ROOT_URLCONF = 'kyusda_backend.urls'
...
WSGI_APPLICATION = 'kyusda_backend.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=EMAIL_HOST_USER or 'no-reply@kyusda.local')
